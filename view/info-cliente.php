...
<body>
    ...
    <main class="h-screen ml-[20rem] pt-11 pl-20 sm:h-full sm:ml-1 sm:px-8">
        ...
        <div class="flex flex-col gap-5 sm:w-full sm:flex-col">
            <div class="flex flex-row">
                <div class="w-[133px] h-[169px] shadow-lg mr-10">Foto 133.33 169</div>
                <div class="py-5 flex flex-col gap-4 sm:flex-col sm:gap-4 sm:items-start">
                    <h2 class="text-xl text-red-600">João Pedro</h2>
                    <span class="text-base text-red-600 font-semibold">23 pontos</span>
                </div>
            </div>
            <div class="flex flex-row flex-wrap gap-2 sm:flex-col sm:gap-4 sm:w-full">
                <p class="w-2/5 sm:w-full">Data do cadastro</p>
                <p class="w-2/5 sm:w-full">CPF</p>
            ...
            <div class="flex flex-row gap-5">
                ...
                <span id="btn-delete" class="w-[100px] py-[3px] px-7 rounded text-neutral-50 font-semibold bg-red-600">Excluir</span>
            </div>
        </div>
